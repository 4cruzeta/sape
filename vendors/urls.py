...
urlpatterns = [
    ...
    path('<int:vendor_id>/orders/<int:order_id>/', views.vendor_order_detail, name='vendor_order_detail'),
    path('<int:vendor_id>/orders/<int:order_id>/edit/', views.vendor_order_edit, name='vendor_order_edit'),
